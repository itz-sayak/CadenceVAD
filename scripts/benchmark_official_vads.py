...
def main() -> None:
    ...
    results: dict[str, object] = {
        "schema": "cadencevad-external-runtime-benchmark-v1",
    ...
    if args.native_benchmark:
        ...
        results["cadencevad_native"] = native
