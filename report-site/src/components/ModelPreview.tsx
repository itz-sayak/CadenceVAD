...
type ModelId = "cadencevad" | "silero" | "ten" | "firered";
...
const models: ModelPreview[] = [
  ...
  },
  {
    ...
    watch: "3.53× CadenceVAD compute advantage by audio-normalized RTF; not accuracy",
    license: "MIT",
  ...
  },
  {
    ...
    watch: "14.2× CadenceVAD compute advantage; license has additional conditions",
  ...
  },
  {
    ...
    watch: "45.2× CadenceVAD compute advantage; FireRed frontend was excluded",
    license: "Apache-2.0",
...
export function ModelPreview() {
  const [selected, setSelected] = useState<ModelId>("cadencevad");
  const model = models.find((candidate) => candidate.id === selected) ?? models[0];
  const localModel = model.id === "cadencevad";
    ...
    <section className="section model-preview-section" id="model-preview">
      <div className="section-heading">
        ...
        <p>
          ...
          intended fit. Only CadenceVAD executes in this browser demo; competitor
