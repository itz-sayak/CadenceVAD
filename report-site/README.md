# CadenceVAD report and browser demo

This package builds the static CadenceVAD benchmark report with Astro. The
...
The microphone and file playground executes CadenceVAD locally. Uploaded audio
...
Prior sibling sites: Geist, square data surfaces,
